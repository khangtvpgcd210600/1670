...
namespace BookStoreMVC.Controllers
{
	public class UsersController : Controller
	{
		...
		public UsersController(BookStoreMVCContext context)
		{
			_context = context;
		}
		...
		public async Task<IActionResult> LoginPost(string na, string pa)
		{
		...
		public async Task<IActionResult> DeleteConfirmed(int id)
		{
			...
			{
				return Problem("Entity set 'BookStoreMVCContext.User'  is null.");
			}
			var user = await _context.User.FindAsync(id);
			if (user != null)
			{
